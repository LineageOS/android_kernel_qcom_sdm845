...
{
	int context_id;
	register u64 r0 asm(R0_STR) = 1;
	register u64 r1 asm(R1_STR) = (uintptr_t)&context_id;
	register u64 r2 asm(R2_STR) = cmd_addr;
	do {
		asm volatile(
			__asmeq("%0", R0_STR)
			__asmeq("%1", R0_STR)
...
static int __scm_call_armv8_32(u32 w0, u32 w1, u32 w2, u32 w3, u32 w4, u32 w5,
				u64 *ret1, u64 *ret2, u64 *ret3)
{
	register u64 r0 asm("w0") = w0;
	register u64 r1 asm("w1") = w1;
	register u64 r2 asm("w2") = w2;
	register u64 r3 asm("w3") = w3;
	register u64 r4 asm("w4") = w4;
	register u64 r5 asm("w5") = w5;
	register u64 r6 asm("w6") = 0;
...
static int __scm_call_armv8_32(u32 w0, u32 w1, u32 w2, u32 w3, u32 w4, u32 w5,
				u64 *ret1, u64 *ret2, u64 *ret3)
{
	register u64 r0 asm("r0") = w0;
	register u64 r1 asm("r1") = w1;
	register u64 r2 asm("r2") = w2;
	register u64 r3 asm("r3") = w3;
	register u64 r4 asm("r4") = w4;
	register u64 r5 asm("r5") = w5;
...
{
	int context_id;
	register u64 r0 asm(R0_STR) = SCM_ATOMIC(svc, cmd, 1);
	register u64 r1 asm(R1_STR) = (uintptr_t)&context_id;
	register u64 r2 asm(R2_STR) = arg1;
...
{
	int context_id;
	register u64 r0 asm(R0_STR) = SCM_ATOMIC(svc, cmd, 2);
	register u64 r1 asm(R1_STR) = (uintptr_t)&context_id;
	register u64 r2 asm(R2_STR) = arg1;
	register u64 r3 asm(R3_STR) = arg2;
...
{
	int context_id;
	register u64 r0 asm(R0_STR) = SCM_ATOMIC(svc, cmd, 3);
	register u64 r1 asm(R1_STR) = (uintptr_t)&context_id;
	register u64 r2 asm(R2_STR) = arg1;
	register u64 r3 asm(R3_STR) = arg2;
	register u64 r4 asm(R4_STR) = arg3;
		...
		u32 arg3, u32 arg4, u32 *ret1, u32 *ret2)
{
	int ret;
	int context_id;
	register u64 r0 asm(R0_STR) = SCM_ATOMIC(svc, cmd, 4);
	register u64 r1 asm(R1_STR) = (uintptr_t)&context_id;
	register u64 r2 asm(R2_STR) = arg1;
	register u64 r3 asm(R3_STR) = arg2;
	register u64 r4 asm(R4_STR) = arg3;
	register u64 r5 asm(R5_STR) = arg4;
	...
	u32 arg3, u32 arg4, u32 arg5, u32 *ret1, u32 *ret2, u32 *ret3)
{
	int ret;
	int context_id;
	register u64 r0 asm(R0_STR) = SCM_ATOMIC(svc, cmd, 5);
	register u64 r1 asm(R1_STR) = (uintptr_t)&context_id;
	register u64 r2 asm(R2_STR) = arg1;
	register u64 r3 asm(R3_STR) = arg2;
	register u64 r4 asm(R4_STR) = arg3;
	register u64 r5 asm(R5_STR) = arg4;
	register u64 r6 asm(R6_STR) = arg5;
...
u32 scm_get_version(void)
{
	...
	register u64 r0 asm(R0_STR);
	register u64 r1 asm(R1_STR);
